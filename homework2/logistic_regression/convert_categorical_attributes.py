...
def solver(dataset):
    train_file = f'./tema2_{dataset}/preprocessed_standardized_{dataset}_train.csv'
    test_file = f'./tema2_{dataset}/preprocessed_standardized_{dataset}_test.csv'
    ...
    new_train_file = train_file.replace('.csv', '_converted.csv')
    new_test_file = test_file.replace('.csv', '_converted.csv')
